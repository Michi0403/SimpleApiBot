...
{
    [DataContract ]
    public class sendMessage : TelegramCommandTemplate
    {
        public sendMessage(HttpClient client, string token, Dictionary<ParamTypeEnum, string> parameter, string httpMethod) : base(client, token, parameter, httpMethod) 
        {
            _routeBaseAdress = @"/sendMessage";
        }
