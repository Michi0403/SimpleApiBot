        ...
        public void ResponseContentIncoming(object sender, GenericEventArgs<string, byte[]> e)
        {
            try
            {
                if(e.EventData != string.Empty)
                {
                    ...
                    _responsefactory.TryAddResponseToBag( _responsefactory.CreateResponseFromRequestAndJson(e.EventData, responseContent, ParamTypeEnum.events));
