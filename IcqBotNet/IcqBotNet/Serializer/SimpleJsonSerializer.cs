...
namespace IcqBotNet.Serializer
{
    public class SimpleJsonSerializer : IJSONSerializer
    {
        ...
        public async Task<Dictionary<ParamTypeEnum, string>> GetJsonEntries(string toJson)
        {
            ...
            using (MemoryStream stream = new MemoryStream(json))
                return await JsonSerializer.DeserializeAsync<Dictionary<ParamTypeEnum, string>>(stream,options);
        }
